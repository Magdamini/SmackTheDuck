...
class Plaster(Item):
    ...
    def use(self, fighter):
        how_much = min(3, fighter.stats[Stats.HEALTH] - fighter.battle_stats[Stats.HEALTH])
...
class Bandage(Item):
    ...
    def use(self, fighter):
        how_much = min(10, fighter.stats[Stats.HEALTH] - fighter.battle_stats[Stats.HEALTH])
        super().use(fighter, Stats.HEALTH, how_much)
...
class MedicalKit(Item):
    ...
    def use(self, fighter):
        super().use(fighter, Stats.HEALTH, fighter.stats[Stats.HEALTH] - fighter.battle_stats[Stats.HEALTH])
