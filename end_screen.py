...
class EndScreen():
    ...
    def render_title(self):
        self.display.blit(self.title, (self.display.get_width() // 2 - self.title.get_width() // 2, 50))
        self.display.blit(self.subtitle, (self.display.get_width() // 2 - self.subtitle.get_width() // 2, 70 + self.title.get_height()))
