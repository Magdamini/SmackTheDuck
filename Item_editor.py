...
class ItemEditor:
    def __init__(self):        
        ...
        self.images = {"00": load_image('tiles/Items/00.png'),
    ...
    def save(self):
        ...
        for m in map_list:
            ...
            for item in self.maps[m].items.values():
                x, y = item.x // self.maps["0"].tile_size, item.y // self.maps["0"].tile_size
                map_dict[str(x) + ";" + str(y)] = {"x": x, "y": y, "type": item.img_name}
            it_dict[m] = map_dict
