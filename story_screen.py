...
lying right next to the door..."""
        self.info = text_image("[Press any key to continue]", 10, "data/fonts/Retro.ttf")
        
        self.feathers = [load_image("/scenes/feather1.png"), load_image("/scenes/feather2.png")]
    ...
    def render_info(self):
        self.display.blit(self.info, (self.display.get_width() // 2 - self.info.get_width() // 2, self.display.get_height() - 30))
